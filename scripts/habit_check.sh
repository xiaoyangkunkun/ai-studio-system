...
cd ${HERMES_HOME:-$HOME/.hermes}/scripts
echo "===== 画像现状 ====="
python3 -c "
import re
t = open('${VAULT_PATH:-$HOME/vault}/entities/用户画像.md', encoding='utf-8').read()
...
print()
print(t[:3000])
print('...(截断,完整见 ${VAULT_PATH:-$HOME/vault}/entities/用户画像.md)')
"
echo ""
echo "===== 基线信息 ====="
